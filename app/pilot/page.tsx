...
const STEPS: Array<{
  ...
  },
  {
    kind: 'decide',
    title: '判定する',
    what: '「通過にする」または「不合格にする」を押す',
    watch: '押す前に迷いましたか。取り消せないと分かっていて、確認が欲しいと思いましたか',
  },
]
    ...
    <Shell active="borderline" years={<YearSwitch seasons={seasons} currentId={season.id} basePath="/pilot" />}>
      ...
      <div className="section">
        <p className="callout">
          ...
          <strong>判定は押したら画面から取り消せない。</strong>
          押す前に迷ったら、迷ったこと自体を教えてほしい。
      ...
      <p className="footnote">
        ...
        この手順で触るのはそのうち最大4件。担当と保留は何度でもやり直せるが、
        <strong>判定だけは画面から取り消せない。</strong>
