---
name: "source-command-structure"
description: "構成基準（.consultant/STRUCTURE.md）を確かめ、崩れていたら直す"
---

# source-command-structure

Use this skill when the user asks to run the migrated source command `structure`.
...
| S4 | `deny` から必須項目が消えた | `.Codex/settings.json` |
| S5 | サブエージェントが消えた | `.Codex/agents/` |
